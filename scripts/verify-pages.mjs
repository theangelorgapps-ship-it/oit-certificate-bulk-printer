...
if (!html.includes("OIT Certificate Printing Workspace") || !html.includes("Certificate printing workspace") || !html.includes('id="namesFile"') || !html.includes('data-design="vitalis-certificate"')) {
